...
public class Tester {
    ...
    public void is(Object got, Object expected, String name, String description,
                   Boolean prints) {
        ...
        if(prints) {
            System.out.println("Test " + description + " failed: " + got + ", "
                    + expected);
        }
    }
    ...
    public void results() {
        ...
        for(int i=0; i<count; i++){
            ...
            if(t.pass){
                ...
                fail++;
                System.out.println("Test \"" + t.description + "\" failed: got "
                        + t.got + ", expected: " + t.expected);
            }
        }
    ...
    // utility - handy to be able to round doubles for comparison
    // pulled from http://stackoverflow.com/questions/2808535/round-a-double-to-2-decimal-places
